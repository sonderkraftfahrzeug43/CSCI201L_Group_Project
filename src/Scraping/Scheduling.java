...
public class Scheduling {
	private Vector<Vector<Section>> all = new Vector<Vector<Section>>();
	...
	public static void testSearch() {
		...
		while (true) {
			String search = "math";
			Vector<Course> c = Data.findCourses(search);
	...
	public static void testSchedule() {
		...
		Course c1 = Data.findCourses("CTIN-488").get(0);
		Course c2 = Data.findCourses("CSCI-353").get(0);
		Course c3 = Data.findCourses("CSCI-420").get(0);
		Course c4 = Data.findCourses("ITP-250").get(0);
		Course c5 = Data.findCourses("CSCI-350").get(0);
...
//		}
	...
	private void scheduleHelper(int index, Schedule _schedule) {		
