      ...
      <div class="container-fluid">
        <div class="row">
           <div class="col-lg-3">
		     ...
		     <h2 style="text-align:center; font-size:20px; font-family:tableTitles>Updates:</h2>
               ...
               <form name="set" method="POST" action="Settings" >
                     <table class="table" style="font-family:tableTitles" align="center">
                       ...
                       <tr>
                        ...
                        <td align="right">
                              <select id="minor" name="minor" style="width:80%; font-size:25px; font-family:tableTitles">
                       ...
                       <tr>
                             <td style="color:white; font-size:30px; text-align:left">Password:</td>
                             <td align="right"><input type="text" name="pw" style="width:80%; font-size:25px"></td>
                       </tr>
                       <tr>
                             <td style="color:white; font-size:30px; text-align:left">Previous Class:</td>
                             <td align="right"><input type="text" name="pc" style="width:80%; font-size:25px"></td>
                       </tr>
                       <tr>
                     ...
                     <div id="ending" style="font-family:tableTitles">
                        <input type="button" name="save" id="save" value="Save Changes" onclick="moveOn()">
                        <input type="submit" name="clear" value="Clear Current Schedule">
